...
Given a skeleton Python script `moviepro.py`, read input files and insert data into `cs1656.sqlite` database.
Provide SQL queries that answer the 12 questions.
